...
Object.entries(user.post).forEach(([k,data])=> {
    ...
    postername.href="../html/profile.html?id="+user.id;
...
btnt.href="../html/chat.html?"+ user.id;
...
header.appendChild(postername);
  ...
  const link = /*base url of websit */ window.location.origin+"/html/profile.html?id="+ user.id;
